...
module Rack::Utils
  ...
  def byte_ranges(env, size, max_ranges: nil); end
  ...
  def get_byte_ranges(http_range, size, max_ranges: nil); end
  ...
  def self.byte_ranges(env, size, max_ranges: nil); end
  ...
  def self.get_byte_ranges(http_range, size, max_ranges: nil); end
