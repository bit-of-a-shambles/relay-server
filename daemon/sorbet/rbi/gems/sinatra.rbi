...
class Sinatra::ExtendedRack < Anonymous_Struct_8
...
class Sinatra::Base
  ...
  def self.helpers(*extensions, &block); end
  def self.host_authorization; end
  def self.host_authorization=(val); end
  def self.host_authorization?; end
  ...
  def self.setup_host_authorization(builder); end
  ...
  def self.static_cache_control?; end
  def self.static_headers; end
  def self.static_headers=(val); end
  def self.static_headers?; end
  def self.stop!; end
